...
export default function communicatingBetweenDockerContainers() {
  delimeterMsg('COMMUNICATING BETWEEN DOCKER CONTAINERS');
  logF(usingLegacylinking);
